...
export default function LecturerLoginPage() {
  ...
  const [email, setEmail] = useState("lecturer1@demo.com");
  ...
  async function handleLogin(event: React.FormEvent<HTMLFormElement>) {
    ...
    if (profile.role !== "lecturer") {
      await supabase.auth.signOut();
      setErrorMessage("This account is not a lecturer account.");
      setLoading(false);
      return;
    }
  ...
  return (
    <main className="min-h-screen bg-[#f3f5f8]">
      ...
      <PortalSubHero
        ...
        description="Access the lecturer review area to open uploaded answer sheets, assign marks, write comments, update submission status, and release student feedback."
        accent="lime"
      />
          ...
          <div className="space-y-8">
            ...
            <div className="grid gap-5 sm:grid-cols-2">
              <div className="rounded-[24px] bg-white p-6 shadow-lg shadow-slate-300/20">
                ...
                <ul className="mt-5 space-y-3 text-sm leading-7 text-slate-700">
                  <li>• Open student uploaded files</li>
                  <li>• Update current submission status</li>
                  <li>• Add marks for each submission</li>
                  <li>• Write lecturer comments</li>
                </ul>
              </div>
              ...
              <div className="rounded-[24px] bg-white p-6 shadow-lg shadow-slate-300/20">
                ...
                <ul className="mt-5 space-y-3 text-sm leading-7 text-slate-700">
                  <li>• Mark submissions after review</li>
                  <li>• Release final feedback to students</li>
                  <li>• Trigger student notifications</li>
                  <li>• Keep workflow centralized</li>
                </ul>
              </div>
            </div>
            ...
            <div className="rounded-[24px] bg-white p-6 shadow-lg shadow-slate-300/20">
              ...
              <p className="mt-3 text-sm leading-7 text-slate-600">
                This lecturer access page is positioned as part of the proposed
                Answer Sheet Portal extension under the Online Accounting platform.
              </p>
            </div>
          </div>
        </div>
